...
<body>
  <!-- Header of the the page that containt the logo of engie and the name of the application and the menu -->
        <header>
            ...
            <ul id="menu">
                <li style='margin-left: -2%;'><a href="#" class='welcome'> <img src='style/img/user.png' alt='Welcome' /><?php echo("   Welcome ".strtoupper($owner[0]).""); ?></a></li>
                <li><a href="../../../View/flows.php" class='flows'> <img src='style/img/flows.png' alt='Flows' />   Flows</a></li>
                <li><a href="../../../View/middleware.php" class='middleware'> <img src='style/img/server.png' alt='Middleware' />   Middlewares</a></li>
                <li><a href="../../../View/component.php" class='component'> <img src='style/img/component.png' alt='Components' />   Components</a></li>
                <li><a href="../../../View/partner.php" class='partner'> <img src='style/img/partner.png' alt='Partners'  />   Partners</a></li>
                <li><a href="../../../View/environment.php" class='environment2'> <img src='style/img/environment.png' alt='Environments' />   Environments</a></li>
                <li class='logout'><a href="../../../Controller/logout.php" > <img src='style/img/logout.png' alt='Logout' />   Logout</a></li>
            </ul>
        </header>
    </br></br></br>
