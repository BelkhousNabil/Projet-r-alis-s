...
function autocomplet_mid() {
	...
	if (keyword.length >= min_length) {
		$.ajax({
			url: '../assets/js/ajaxMidd2_refresh.php',
			type: 'POST',
...
function autocomplet_comp() {
	...
	if (keyword.length >= min_length) {
		$.ajax({
			url: '../assets/js/ajaxComp_Rest2_refresh.php',
			type: 'POST',
			data: {keyword:keyword},
			success:function(data){
...
function autocomplet_comp1() {
	...
	if (keyword.length >= min_length) {
		$.ajax({
			url: '../assets/js/ajaxComp1_Rest2_refresh.php',
			type: 'POST',
			data: {keyword:keyword},
			success:function(data){
...
function autocomplet_part1() {
	...
	if (keyword.length >= min_length) {
		$.ajax({
			url: '../assets/js/ajaxSource_Rest2_refresh.php',
			type: 'POST',
			data: {keyword:keyword},
			success:function(data){
...
function autocomplet_part2() {
	...
	if (keyword.length >= min_length) {
		$.ajax({
			url: '../assets/js/ajaxDestination_Rest2_refresh.php',
			type: 'POST',
			data: {keyword:keyword},
			success:function(data){
