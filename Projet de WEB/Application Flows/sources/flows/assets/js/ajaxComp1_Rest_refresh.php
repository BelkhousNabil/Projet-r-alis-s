<?php
	  ...
	  /**
        ajaxComp1_Rest_refresh.php 
            description --> This page allows the autocompletion when we search the seconde component
            Controllers --> None
            Model --> None
    	**/
...
foreach ($list as $rs) {
	...
	// add new option
    echo '<li onclick="set_item_comp1(\''.str_replace("'", "\'", $rs['restricted_name']).'\')">'.$restricted_name.'</li>';
}
?>