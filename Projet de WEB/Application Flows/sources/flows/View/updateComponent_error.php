<?php
   ...
   /**
        updateComponent_error.php 
            description --> Error page of the updating that treat a component
  ...
  require_once '../Model/getEnvName_Model.php';
    ...
    require_once '../Model/updatedataComp_Model.php';
...
<html>
    ...
    <body>
        ...
        <div class="addEdit_BTN" id='midBTN'>
         ...
         <!-- Error message -->
        <div class = "Verif"> 
          <p><b>This component name already exist</b></p>
        </div>
        
        <!-- Form that allows to update a component -->
        <fieldset class="add_midd">
            
                <form method = "POST" action = "../Controller/modifyComp_Controller.php" name = "form_add_comp">
                    <table class="table_add">
                       <tr>  
                        <tr>
                          <td class="line"> <label><b>Name</b></label> </td>
                          <td class="line"> <?php echo("<input required style='border-color:red' type='text' name='name_mid' value='".$name."' >"); ?> </td>
                       </tr>
                       <tr hidden='true';>
