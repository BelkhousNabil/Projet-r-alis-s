<?php
   ...
   /**
        updatePartner_error.php 
            description --> Error page of the updating that treat a partner
            Controllers --> modifyPart_Controller.php
            Model --> modifyPart_Model
    **/
...
<html>
    ...
    <body>
        ...
        <!-- Error message -->
        <div class = "Verif"> 
          <p><b>This partner name already exist</b></p>
        </div>
