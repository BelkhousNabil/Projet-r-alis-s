<?php
    ...
    /**
        addMiddleware_error.php 
            description --> Allows to notify the errors at the momement of addind a middleware
            Controllers --> addMidd_Controller.php
...
<html>
    ...
    <body>
        ...
        <!-- Error message -->
        <div class = "Verif"> 
          <p><b>The middleware name already exist</b></p>
        </div>
        
        <!-- Form that allows to add the middleware -->
        <fieldset class="add_midd" id="add_midd_Env">
            
                <form method = "POST" action = "../Controller/addMidd_Controller.php" name = "form_add_comp">
                       ...
                       <tr>
                        <td class="line"> <label><b>Client</b></label> </td>
                          <?php
                              $i=0;
                              while($i < $cptEv[0]){                                  
                                  echo("<td class='line'> <textarea rows='3' cols='50' name='client".++$i."'> </textarea> </td>");
                              }
                          ?>
                       </tr>
                       ...
                       <tr>
                        <td class="line"> <label><b>Users</b></label> </td>
                          <?php
                              $i=0;
                              while($i < $cptEv[0]){                                  
                                  echo("<td class='line'> <textarea rows='3' cols='50' name='users".++$i."'> </textarea> </td>");
                              }
                          ?>
                       </tr>
                       ...
                       <tr>
                        <td class="line"> <label><b>Contact client</b></label> </td>
                          <?php
                              $i=0;
                              while($i < $cptEv[0]){                                  
                                  echo("<td class='line'> <textarea rows='3' cols='50' name='contact_cl".++$i."'> </textarea> </td>");
                              }
                          ?>
                       </tr>
                       ...
                       <tr>
                        <td class="line"> <label><b>Service level offering</b></label> </td>
                          <?php
                              $i=0;
                              while($i < $cptEv[0]){                                  
                                  echo("<td class='line'> <textarea rows='3' cols='50' name='service".++$i."'> </textarea> </td>");
                              }
                          ?>
                       </tr>
                       ...
                       <tr>
                        <td class="line"> <label><b>Application Manager</b></label> </td>
                          <?php
                              $i=0;
                              while($i < $cptEv[0]){                                  
                                  echo("<td class='line'> <textarea rows='3' cols='50' name='appli_manager".++$i."'> </textarea> </td>");
                              }
                          ?>
                       </tr>
                       ...
                       <tr>
                        <td class="line"> <label><b>Application Management team</b></label> </td>
                          <?php
                              $i=0;
                              while($i < $cptEv[0]){                                  
                                  echo("<td class='line'> <textarea rows='3' cols='50' name='appli_team".++$i."'> </textarea> </td>");
                              }
                          ?>
                       </tr>
                       ...
                       <tr>
                        <td class="line"> <label><b>Production team</b></label> </td>
                          <?php
                              $i=0;
                              while($i < $cptEv[0]){                                  
                                  echo("<td class='line'> <textarea rows='3' cols='50' name='prod_team".++$i."'> </textarea> </td>");
                              }
                          ?>
                       </tr>
