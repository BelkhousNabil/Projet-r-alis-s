<?php
    ...
    /**
        component.php 
            description --> Allows to display the component that are in the DB of the application
            Controllers --> None
            Model --> None
    **/
    ...
    $q="select count(*) \"total\"  from component";
    $ros=$dbh->query($q);
    $row=($ros->fetch());
    $total=$row['total'];
    $dis=30;
    ...
    $k=($page_cur-1)*$dis;
    $q="SELECT * FROM component ORDER BY name ASC limit $k,$dis";
    $ros=$dbh->query($q);
...
<html>
    ...
    <body>
        ...
        <div class="addEdit_BTN" id='midBTN'>
            ...
            <a href="../Controller/exportFileComponent_Controller.php" id="a6" style='margin-left:18%;margin-right:3%;'> <img src="../assets/img/export.png"> <span><b>Export Components</b></span></a>
            <a href="../View/uploadFileComponents.php" id="a1" style='margin-left:1%;'> <img src="../assets/img/add.png"> <span><b>Import components</b></span></a>
        ...
        <!-- Display the component that are in the DB into a table -->
        <div>
            <div class="display_fl_comp">
                            ...
                            <?php
                                while($row=$ros->fetch()){
                                    echo ("<tr data-url='index.html'>");
                                        ...
                                        echo ("<td class='text-left' style='overflow: hidden; word-wrap: break-word;'> ".$row[4]."</td>");
                                        echo ("<td class='text-left' style='overflow: hidden; word-wrap: break-word;'> ".$row[5]."</td>");
                                        ...
                                        echo("<td class='text-left'  style='text-align: center' id='manage'>");
                                            echo("<a href=\"../Controller/updateComp_table_Controller.php?mid=$row[0]\" class='amanage'>");
                                        ...
                                        echo("<td class='text-left' style='text-align: center' id='manage' style='max-width: 150px; overflow: hidden; word-wrap: break-word;'>");
                                            echo("<a href=\"../Controller/deleteComp_table_Controller.php?mid=$row[0]\" class='amanage'>");
                    ...
                    <div class='pagination'>
                        ...
                        <?php
                            if($page_cur>1){
                                    echo '<a class=\'aBtn\' href="component.php?page='.($page_cur-1).'" style=" cursor:pointer;color:white ;" ><input style=" margin:0;padding:0; text-align:center; cursor:pointer;background-color:#0078BE;border-radius:3px;width:20px;height:20px;color:white;font-size:12px;font-weight:bold;" type="button" value="<"></a> ';
                            }
                            else{
                            ...
                            for($i=1;$i<=$total_page;$i++){
                                if($page_cur==$i){ 
                                    echo '<input  style="margin:0;padding:0; text-align:center; border-color:#0078BE; background-color:#0078BE ;border-radius:3px;width:20px;height:20px;color:black;font-size:13px;font-weight:bold;" type="button" value="'.$i.'"> ';
                                        ...
                                        echo '<a class=\'aBtn\' href="component.php?page='.$i.'"> <input style="margin:0;padding:0; text-align:center; cursor:pointer;background-color:#0078BE; border-radius:3px;width:20px;height:20px;color:white;font-size:13px;" type="button" value="'.$i.'"> </a> ';       
                                }
                            }
                            if($page_cur<$total_page){      
                                echo '<a class=\'aBtn\' href="component.php?page='.($page_cur+1).'"><input style="margin:0;padding:0; text-align:center; cursor:pointer;background-color:#0078BE; border-radius:3px;width:20px;height:20px;color:white;font-size:13px;font-weight:bold;" type="button" value=">"></a>';     
                            }
                            else{
                                echo '<input style="margin:0;padding:0; text-align:center; border-color:#0078BE; background-color:#0078BE; border-radius:3px;width:20px;height:20px;color:black;font-size:13px;font-weight:bold;" type="button" value=">"> ';
                            }
