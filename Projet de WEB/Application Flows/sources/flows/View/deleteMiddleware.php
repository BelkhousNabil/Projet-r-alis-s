<?php
    ...
    /**
        deleteMiddleware.php 
            description --> This page permit to confirm the fact that we will delete a middleware
            Controllers --> deleteMidd_Controller.php
...
<html>
    ...
    <body>
        ...
        <div class="Etat_gestion">
            <form method = "POST" action = "../Controller/deleteMidd_Controller.php" name = "form_delete_midd">
                 <div class="confirm">
