<?php
    ...
    /**
        middleware.php 
            description --> Allows to display the middlewares that are in the DB of the application
            Controllers --> None
            Model --> None
    **/
    ...
    $q="select count(*) \"total\"  from middleware";
    $ros=$dbh->query($q);
    $row=($ros->fetch());
    $total=$row['total'];
    $dis=30;
    ...
    $k=($page_cur-1)*$dis;
    $q="SELECT * FROM middleware ORDER BY name ASC limit $k,$dis";
    $ros=$dbh->query($q);
...
<html>
    ...
    <body>
        ...
        <header style='width:3030px;'>
            <div class='menuItems'>
                <img class='logo' src="../assets/img/logo-scroll.png" alt="engie">
                <h2 style='margin-left:35px;'>Flows</h2>
                </br>
            </div>  
            <ul id="menu">
                <li style='margin-left: -5%;' ><a href="#" class='welcome'> <img src='../assets/img/user.png' alt='Welcome' /><?php echo("   Welcome ".strtoupper($owner[0]).""); ?></a></li>
        ...
        <div class="addEdit_BTN" id='midBTN'>
            ...
            <a href="../Controller/exportFileMiddleware_Controller.php" id="a6" style='margin-left:18%;margin-right:3%;'> <img src="../assets/img/export.png"> <span><b>Export Middlewares</b></span></a>
            <a href="../View/uploadFileMiddlewares.php" id="a1" style='margin-left:1%;'> <img src="../assets/img/add.png"> <span><b>Import middlewares</b></span></a>
        ...
        <!-- Display the flows that are the DB into a table -->
        <div>
            <div class="display_fl_comp">
                    <table class="table-fill" style='width:3000px;'>
                        <thead>
                            <tr>
                                ...
                                <th class="text-left">Contacts client</th>
                                <th class="text-left">Service level offering</th>
                                <th class="text-left">Application manager</th>
                                <th class="text-left">Application management team</th>
                                <th class="text-left">Production team</th>
                                ...
                                <th class="text-left">Access accounts</th>
                            ...
                            <?php
                                while($row=$ros->fetch()){
                                    echo ("<tr data-url='index.html'>");
                                        ...
                                        echo ("<td class='text-left' style='overflow: hidden; word-wrap: break-word; max-width:200px;'> ".$row[6]."</td>");
                                        echo ("<td class='text-left' style='overflow: hidden; word-wrap: break-word; max-width:200px;'> ".$row[7]."</td>");
                                        echo ("<td class='text-left' style='overflow: hidden; word-wrap: break-word; max-width:200px;'> ".$row[8]."</td>");
                                        echo ("<td class='text-left' style='overflow: hidden; word-wrap: break-word;'> ".$row[9]."</td>");
                                        echo ("<td class='text-left' style='overflow: hidden; word-wrap: break-word;'> ".$row[10]."</td>");
                                        ...
                                        echo ("<td class='text-left' style='overflow: hidden; word-wrap: break-word; max-width:200px;'> ".$row[11]."</td>");

                                        echo ("<td class='text-left' style=' overflow: hidden; word-wrap: break-word; max-width:200px; '> ".$res[3]."</td>");
                                        
                                        echo ("<td class='text-left' style=' overflow: hidden; word-wrap: break-word; max-width:200px; '> ".$res[4]."</td>");
                                        echo ("<td class='text-left' style=' overflow: hidden; word-wrap: break-word; max-width:200px; '> ".$res[5]."</td>");
                                        echo ("<td class='text-left' style=' overflow: hidden; word-wrap: break-word; max-width:200px; '> ".$res[6]."</td>");

                                        echo("<td class='text-left'  style='text-align: center' id='manage' style='max-width: 150px; overflow: hidden; word-wrap: break-word;'>");
                                            echo("<a href=\"../Controller/updateMidd_table_Controller.php?mid=$row[0]\" class='amanage'>");
                                                echo("<img src='../assets/img/s2.png' alt='manage'>");
                                            echo("</a>");
                                            echo("</td>");
                                        echo("<td class='text-left' style='text-align: center' id='manage' style='max-width: 150px; overflow: hidden; word-wrap: break-word;'>");
                                            echo("<a href=\"../Controller/deleteMidd_table_Controller.php?mid=$row[0]\" class='amanage'>");
                    ...
                    <div class='pagination'>
                        ...
                        <?php
                            if($page_cur>1){
                                    echo '<a class=\'aBtn\' href="middleware.php?page='.($page_cur-1).'" style=" cursor:pointer;color:white ;" ><input style=" margin:0;padding:0; text-align:center; cursor:pointer;background-color:#0078BE;border-radius:3px;width:20px;height:20px;color:white;font-size:12px;font-weight:bold;" type="button" value="<"></a> ';
                            }
                            else{
                            ...
                            for($i=1;$i<=$total_page;$i++){
                                if($page_cur==$i){ 
                                    echo '<input  style="margin:0;padding:0; text-align:center; border-color:#0078BE; background-color:#0078BE ;border-radius:3px;width:20px;height:20px;color:black;font-size:13px;font-weight:bold;" type="button" value="'.$i.'"> ';
                                        ...
                                        echo '<a class=\'aBtn\' href="middleware.php?page='.$i.'"> <input style="margin:0;padding:0; text-align:center; cursor:pointer;background-color:#0078BE; border-radius:3px;width:20px;height:20px;color:white;font-size:13px;" type="button" value="'.$i.'"> </a> ';       
                                }
                            }
                            if($page_cur<$total_page){      
                                echo '<a class=\'aBtn\' href="middleware.php?page='.($page_cur+1).'"><input style="margin:0;padding:0; text-align:center; cursor:pointer;background-color:#0078BE; border-radius:3px;width:20px;height:20px;color:white;font-size:13px;font-weight:bold;" type="button" value=">"></a>';     
                            }
                            else{
                                echo '<input style="margin:0;padding:0; text-align:center; border-color:#0078BE; background-color:#0078BE; border-radius:3px;width:20px;height:20px;color:black;font-size:13px;font-weight:bold;" type="button" value=">"> ';
                            }
