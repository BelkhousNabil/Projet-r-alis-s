<?php
    ...
    /**
        editMiddleware.php 
            description --> Allows to search specific middleware and update or delete it
            Controllers --> update_Controller.php
...
<html>
    ...
    <body>
        ...
        <!-- Form that allows to serach, edit and delete a middleware -->
        <fieldset>
          <legend> Search </legend>
            <form method = "POST" action = "../Controller/update_Controller.php" name = "form_update">
               
               <div class="label_div"><b>Name  : </b></div>
                <div class="input_container">
                    <input type="text" required id="mid_name" name="mid" required onkeyup="autocomplet()">
