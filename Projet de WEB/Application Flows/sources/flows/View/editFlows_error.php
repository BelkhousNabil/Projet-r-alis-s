<?php
   ...
   /**
        editFlows_error.php 
            description --> Error in the research of a flow to edit it
            Controllers --> updateEdit_Controller.php
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../assets/js/scriptFlows.js"></script>

        <!-- Script that allows to hide the autocomplete list -->
    ...
    <div class="addEdit_BTN">
        ...
        <!-- Form that allows to serach, edit and delete a flow -->
        <fieldset>
          <legend> Search </legend>
            <form method = "POST" action = "../Controller/updateEdit_Controller.php" name = "form_update">
               
               <div class="label_div"><b>Name  : </b></div>
                <div class="input_container">
                    <input type="text" id="mid_name" name="mid" required onkeyup="autocompletFlow()">
              ...
              <input type='submit' name='open' id='open' value=" "  >
        ...
        <div class = "Verif_update"> 
          <p><b>This flow does't exist</b></p>
        </div>
