<?php
    /**
        uploadFilepartnerts.php 
            description --> This page permit to upload a file of partners
            Controllers --> uploadFileMidd_Controller.php
            Model --> None
    **/
...
<html>
    <head>
        ...
        <script type="text/javascript">
            function GetNameFile() {
                ...
                if(name!="Auto-Generated-Part.xlsx"){
    ...
    <body>
        ...
        <div class="addEdit_BTN" id='midBTN'>
         ...
         <form id="upload" action="../Controller/uploadFilePart_Controller.php" method="POST" enctype="multipart/form-data">

            <fieldset id='uploadField'>
                <div>               
                    <div class="addEdit_BTN">
                        <a href="../Controller/fileGeneratorPart_Controller.php" id="a4"> <img src="../assets/img/download.png"> <span><b>Download xlsx template file</b></span></a></br></br></br>
                    </div>
            ...
            <input type='submit' name='uploadFlows' id='uploadFlows' value="Add partners" style='margin-left:45%;'>
        </form>
