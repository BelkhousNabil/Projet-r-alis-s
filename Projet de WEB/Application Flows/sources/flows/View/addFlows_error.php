<?php
  ...
  /**
        addFlows_error.php 
            description --> This page permit to notify the fact that on of the params are false and doesn't exist in the DB application
...
<html>
    ...
    <div class="addEdit_BTN">
        ...
        <!-- Error message -->
          <div class = "Err_flows"> 
            <p><b>Please verify your parameters, use the autocomplete feature to avoid errors</b></p>
          </div>

        <!-- Form that allows to add the flows with thier data -->
        <fieldset style='margin-top:-2%;' class="add_field" id="add_flow">
