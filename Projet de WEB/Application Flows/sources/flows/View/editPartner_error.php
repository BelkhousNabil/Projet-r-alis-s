<?php
   ...
   /**
        editPartner_error.php 
            description --> Error in the research of a partner to edit it
            Controllers --> updatePart_Controller.php
...
<html>
    ...
    <body>
        ...
        <!-- Form that allows to serach, edit and delete a partner -->
        <fieldset>
          <legend> Search </legend>
            <form method = "POST" action = "../Controller/updatePart_Controller.php" name = "form_update">
        ...
        <div class = "Verif_update"> 
          <p><b>This partner does't exist</b></p>
        </div>
