package org.Nabil.web.configuration;
...
import org.Nabil.web.interceptor.bundling.AddBundlingModelToViewModelInterceptor;
import org.Nabil.web.interceptor.bundling.WroModelHolder;
...
@EnableWebMvc
@Configuration
@ComponentScan(basePackages = {"org.Nabil.web"})
